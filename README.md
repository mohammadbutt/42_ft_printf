...
|    `L`   | `f`|16 bytes or 128 bits |For floating point types expects `long double` or `double long` argument   | (264-1)* 2 <sup>16320</sup> or 18446744073709551615 * 2  <sup>16320</sup>|
