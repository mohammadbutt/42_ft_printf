...
|----------|------------|------------|-------------------------------------------------------------------------------|------------------- |
|   `hh`   |`d` `u` `o` `x` `X` |1 byte or 8 bits     | For integer type, `d`, expects `int` argument which is converted to `char`. <br> For unsigned types, `u` `o` `x` `X`, which is converted to `unsigned char`.                | -128 to 127        |
