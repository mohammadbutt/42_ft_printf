# ft_printf: Unix-like command to format and print data

### Purpose of the project is to recode printf(3)

#### Project file: [ft_printf](https://github.com/mohammadbutt/42_ft_printf/blob/master/Media/ft_printf.en.pdf)
